          ...
          <div className={styles.heroCardHeader}>
            <div>
              <p className={styles.muted}>
                Публичная комната • {publicRoomLabel}
              </p>
            </div>
            ...
            <span
              className={[
                styles.pill,
                visiblePublicRoom ? styles.success : styles.mutedPill,
              ].join(" ")}
            >
      ...
      <section className={styles.grid}>
        ...
        <Card className={styles.sectionCard}>
          ...
          {!user && (
            <p className={styles.note}>
              Нужно войти, чтобы подключиться к чату.
            </p>
          )}
        </Card>
        ...
        <Card className={styles.sectionCard}>
          ...
          <div className={styles.form}>
            ...
            {!isOnline && (
              <p className={styles.note}>
                Нет сети — создание комнаты недоступно.
              </p>
            )}
          </div>
        </Card>
        ...
        <Card className={styles.sectionCard}>
          ...
          {!user ? (
            <p className={styles.muted}>
              Войдите, чтобы видеть участников онлайн.
            </p>
          ) : presenceLoading ? (
