 ...
 *
 * Компонент объединяет вкладки друзей, онлайна, входящих и исходящих запросов,
 * а также список заблокированных пользователей. Все действия завязаны на
 * `useFriends`, а переход в личный чат строится через публичный ref собеседника.
 */
