...
import type { IApiService, UpdateGroupInput, UpdateProfileInput } from '../domain/interfaces/IApiService'
...
class ApiService implements IApiService {
  ...
  public async editMessage(slug: string, messageId: number, content: string) {
    return this.runWithDecode(async () => editMessage(this.apiClient, slug, messageId, content))
  }

  public async deleteMessage(slug: string, messageId: number) {
    return this.runWithDecode(async () => deleteMessage(this.apiClient, slug, messageId))
  }

  public async addReaction(slug: string, messageId: number, emoji: string) {
    return this.runWithDecode(async () => addReaction(this.apiClient, slug, messageId, emoji))
  }

  public async removeReaction(slug: string, messageId: number, emoji: string) {
    return this.runWithDecode(async () => removeReaction(this.apiClient, slug, messageId, emoji))
  }

  public async searchMessages(slug: string, query: string) {
    return this.runWithDecode(async () => searchMessages(this.apiClient, slug, query))
  }

  public async uploadAttachments(slug: string, files: File[], options?: { onProgress?: (percent: number) => void; messageContent?: string; replyTo?: number | null; signal?: AbortSignal }) {
    return this.runWithDecode(async () => uploadAttachments(this.apiClient, slug, files, options))
  }

  public async markRead(slug: string, messageId?: number) {
    return this.runWithDecode(async () => markRead(this.apiClient, slug, messageId))
  }
  ...
  public async sendFriendRequest(username: string) {
    return this.runWithDecode(async () => sendFriendRequest(this.apiClient, username))
  }
  ...
  public async acceptFriendRequest(friendshipId: number) {
    return this.runWithDecode(async () => acceptFriendRequest(this.apiClient, friendshipId))
  }

  public async declineFriendRequest(friendshipId: number) {
    return this.runWithDecode(async () => declineFriendRequest(this.apiClient, friendshipId))
  }
  ...
  // --- Groups ---
  public async createGroup(data: { name: string; description?: string; isPublic?: boolean; username?: string | null }) {
    return this.runWithDecode(async () => createGroup(this.apiClient, data))
  }

  public async getPublicGroups(params?: { search?: string; page?: number; pageSize?: number }) {
    return this.runWithDecode(async () => getPublicGroups(this.apiClient, params))
  }

  public async getMyGroups(params?: { search?: string; page?: number; pageSize?: number }) {
    return this.runWithDecode(async () => getMyGroups(this.apiClient, params))
  }

  public async getGroupDetails(slug: string) {
    return this.runWithDecode(async () => getGroupDetails(this.apiClient, slug))
  }

  public async updateGroup(slug: string, data: UpdateGroupInput) {
    return this.runWithDecode(async () => updateGroup(this.apiClient, slug, data))
  }
  ...
  public async getGroupMembers(slug: string, params?: { page?: number; pageSize?: number }) {
    return this.runWithDecode(async () => getGroupMembers(this.apiClient, slug, params))
  }

  public async kickMember(slug: string, userId: number) {
    return this.runWithDecode(async () => kickMember(this.apiClient, slug, userId))
  }

  public async banMember(slug: string, userId: number, reason?: string) {
    return this.runWithDecode(async () => banMember(this.apiClient, slug, userId, reason))
  }

  public async unbanMember(slug: string, userId: number) {
    return this.runWithDecode(async () => unbanMember(this.apiClient, slug, userId))
  }

  public async muteMember(slug: string, userId: number, durationSeconds = 3600) {
    return this.runWithDecode(async () => muteMember(this.apiClient, slug, userId, durationSeconds))
  }

  public async unmuteMember(slug: string, userId: number) {
    return this.runWithDecode(async () => unmuteMember(this.apiClient, slug, userId))
  }

  public async getBannedMembers(slug: string) {
    return this.runWithDecode(async () => getBannedMembers(this.apiClient, slug))
  }

  public async createInvite(slug: string, data?: { maxUses?: number; expiresInHours?: number }) {
    return this.runWithDecode(async () => createInvite(this.apiClient, slug, data))
  }
  ...
  public async revokeInvite(slug: string, code: string) {
    return this.runWithDecode(async () => revokeInvite(this.apiClient, slug, code))
  }

  public async getInvitePreview(code: string) {
    return this.runWithDecode(async () => getInvitePreview(this.apiClient, code))
  }
  ...
  public async getJoinRequests(slug: string) {
    return this.runWithDecode(async () => getJoinRequests(this.apiClient, slug))
  }

  public async approveJoinRequest(slug: string, requestId: number) {
    return this.runWithDecode(async () => approveJoinRequest(this.apiClient, slug, requestId))
  }

  public async rejectJoinRequest(slug: string, requestId: number) {
    return this.runWithDecode(async () => rejectJoinRequest(this.apiClient, slug, requestId))
  }

  public async getPinnedMessages(slug: string) {
    return this.runWithDecode(async () => getPinnedMessages(this.apiClient, slug))
  }

  public async pinMessage(slug: string, messageId: number) {
    return this.runWithDecode(async () => pinMessage(this.apiClient, slug, messageId))
  }

  public async unpinMessage(slug: string, messageId: number) {
    return this.runWithDecode(async () => unpinMessage(this.apiClient, slug, messageId))
  }

  public async transferOwnership(slug: string, userId: number) {
    return this.runWithDecode(async () => transferOwnership(this.apiClient, slug, userId))
  }
  ...
  public async createRoomRole(slug: string, data: { name: string; color?: string; permissions?: number }) {
    return this.runWithDecode(async () => createRoomRole(this.apiClient, slug, data))
  }

  public async updateRoomRole(slug: string, roleId: number, data: Partial<{ name: string; color: string; permissions: number; position: number }>) {
    return this.runWithDecode(async () => updateRoomRole(this.apiClient, slug, roleId, data))
  }

  public async deleteRoomRole(slug: string, roleId: number) {
    return this.runWithDecode(async () => deleteRoomRole(this.apiClient, slug, roleId))
  }

  public async getMemberRoles(slug: string, userId: number) {
    return this.runWithDecode(async () => getMemberRoles(this.apiClient, slug, userId))
  }

  public async setMemberRoles(slug: string, userId: number, roleIds: number[]) {
    return this.runWithDecode(async () => setMemberRoles(this.apiClient, slug, userId, roleIds))
  }

  public async getRoomOverrides(slug: string) {
    return this.runWithDecode(async () => getRoomOverrides(this.apiClient, slug))
  }

  public async createRoomOverride(slug: string, data: { targetRoleId?: number; targetUserId?: number; allow?: number; deny?: number }) {
    return this.runWithDecode(async () => createRoomOverride(this.apiClient, slug, data))
  }

  public async updateRoomOverride(slug: string, overrideId: number, data: Partial<{ allow: number; deny: number }>) {
    return this.runWithDecode(async () => updateRoomOverride(this.apiClient, slug, overrideId, data))
  }

  public async deleteRoomOverride(slug: string, overrideId: number) {
    return this.runWithDecode(async () => deleteRoomOverride(this.apiClient, slug, overrideId))
  }

  public async getMyPermissions(slug: string) {
    return this.runWithDecode(async () => getMyPermissions(this.apiClient, slug))
  }

  public async globalSearch(query: string, params?: { usersLimit?: number; groupsLimit?: number; messagesLimit?: number }) {
    return this.runWithDecode(async () => globalSearch(this.apiClient, query, params))
  }

  public async getRoomAttachments(slug: string, params?: { limit?: number; before?: number }) {
    return this.runWithDecode(async () => getRoomAttachments(this.apiClient, slug, params))
  }
}
